    ...
    <Modal visible={visible} animationType="slide" statusBarTranslucent>
      <View className="flex-1 bg-background">
        ...
        >
          ...
          <Pressable
            onPress={pickImage}
            className={`bg-surfaceLight border border-border rounded-2xl overflow-hidden mb-6 items-center justify-center active:scale-[0.98] ${!currentImagePreview ? "min-h-[120px] border-dashed" : ""}`}
          >
            {currentImagePreview ? (
